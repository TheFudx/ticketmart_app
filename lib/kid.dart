...
Widget _buildImageRowWithButtons(BuildContext context) {
    ...
    child: Row(
      children: [
        _buildImageWithButton(
            context, 'assets/images/kid1.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithButton(
            context, 'assets/images/kid2.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithButton(
            context, 'assets/images/kid3.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithButton(
            context, 'assets/images/kid4.png'),
      ],
    ),
  );
}
 ...
 Widget _buildImageRowWithPrices(BuildContext context) {
  return SingleChildScrollView(
    ...
    child: Row(
      children: [
        _buildImageWithPrice(context, 'assets/images/kid1.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithPrice(
            context, 'assets/images/kid2.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithPrice(context, 'assets/images/kid3.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithPrice(context, 'assets/images/kid4.png'),
      ],
    ),
  );
}
