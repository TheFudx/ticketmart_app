...
class AmusementParkPage extends StatelessWidget {
  const AmusementParkPage({super.key});
  ...
  Widget _buildCategoryRow(BuildContext context) {
    return Row(
      ...
      children: [
        _buildCategory('Theme Parks'),
        _buildCategory('Water Parks'),
        _buildCategory('Resorts'),
        _buildCategory('Snow Parks'),
      ],
    );
  }
...
Widget _buildImageRowWithButtons(BuildContext context) {
    ...
    child: Row(
      children: [
        _buildImageWithButton(
            context, 'assets/images/imagica.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithButton(
            context, 'assets/images/waterkingdom.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithButton(
            context, 'assets/images/wetnjoy.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithButton(
            context, 'assets/images/imagica.png'),
      ],
 ...
 Widget _buildImageRowWithPrices(BuildContext context) {
  return SingleChildScrollView(
    ...
    child: Row(
      children: [
        _buildImageWithPrice(context, 'assets/images/imagica.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithPrice(
            context, 'assets/images/waterkingdom.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithPrice(context, 'assets/images/wetnjoy.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithPrice(context, 'assets/images/imagica.png'),
      ],
    ),
