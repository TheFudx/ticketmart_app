...
Widget _buildCategoryRow(BuildContext context) {
  return SingleChildScrollView(
    ...
    child: Row(
      children: [
        _buildCategory('Arts & Crafts'),
        _buildCategory('Food & Drinks'),
        _buildCategory('Masterclass'),
        _buildCategory('Education'),
        _buildCategory('Painting'),
        _buildCategory('Business'),
        _buildCategory('Upskill'),
        _buildCategory('Wellness'),
        _buildCategory('Dance'),
        _buildCategory('Health & Fitness'),
        _buildCategory('Photography'),
        _buildCategory('Technology'),
        _buildCategory('Environment'),
        _buildCategory('Fashion and Beauty'),
        _buildCategory('Film Making'),
      ],
    ),
  );
}
...
Widget _buildImageRowWithButtons(BuildContext context) {
    ...
    child: Row(
      children: [
        _buildImageWithButton(
            context, 'assets/images/workshop1.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithButton(
            context, 'assets/images/workshop2.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithButton(
            context, 'assets/images/workshop3.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithButton(
            context, 'assets/images/workshop4.png'),
      ],
    ),
  );
}
 ...
 Widget _buildImageRowWithPrices(BuildContext context) {
  return SingleChildScrollView(
    ...
    child: Row(
      children: [
        _buildImageWithPrice(context, 'assets/images/workshop1.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithPrice(
            context, 'assets/images/workshop2.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithPrice(context, 'assets/images/workshop3.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithPrice(context, 'assets/images/workshop4.png'),
      ],
    ),
  );
}
