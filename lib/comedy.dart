  ...
  Widget _buildCategoryRow(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Row(
        ...
        children: [
          _buildCategory('Stand Up Comedy'),
          _buildCategory('Open Mic Comedy'),
          _buildCategory('Improv Comedy'),
          _buildCategory('Roast'),
...
Widget _buildImageRowWithButtons(BuildContext context) {
    ...
    child: Row(
      children: [
        _buildImageWithButton(
            context, 'assets/images/comedy1.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithButton(
            context, 'assets/images/comedy2.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithButton(
            context, 'assets/images/comedy3.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithButton(
            context, 'assets/images/comedy4.png'),
      ],
    ),
  );
}
 ...
 Widget _buildImageRowWithPrices(BuildContext context) {
  return SingleChildScrollView(
    ...
    child: Row(
      children: [
        _buildImageWithPrice(context, 'assets/images/comedy1.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithPrice(
            context, 'assets/images/comedy2.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithPrice(context, 'assets/images/comedy3.png'),
        const SizedBox(width: 16), // Spacing between images
        _buildImageWithPrice(context, 'assets/images/comedy4.png'),
      ],
    ),
  );
}
