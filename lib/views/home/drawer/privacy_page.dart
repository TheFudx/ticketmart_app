              ...
              Text.rich(
                TextSpan(
                  children: [
                    ...
                    TextSpan(
                      text:
                          'Welcome to TicketMart. This Privacy Policy explains how we collect, use, disclose, and protect your information when you use our services. By using TicketMart, you agree to the collection and use of information in accordance with this policy.\n\n',
                    ...
                    TextSpan(
                      text:
                          'a. Personal Information: When you register an account or book a ticket, we may collect personal information such as your name, email address, phone number, payment information, and any other details you provide.\n\n'
                    ...
                    TextSpan(
                      text:
                          'We may update our Privacy Policy from time to time. Any changes will be posted on this page, and we will notify you of any significant changes through the app or by email.',
                      style: TextStyle(fontSize: 16),
                    ),
                  ],
                ),
